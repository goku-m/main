...
```
backend/
├── cmd/apps/                 # Gateway entry point
├── apps/                     # Portfolio projects
│   └── agrifolio/
│       ├── project.go        # Registers routes/config
│       ├── api/              # App-specific API layers
...
│   ├── lib/                  # Shared libraries (jobs, email, etc.)
│   └── validation/           # Request validation
├── web/
│   ├── static/               # Global static files (OpenAPI spec)
│   └── templates/            # Global email templates
...
#### Handlers (`apps/agrifolio/api/handler/`)
...
#### Services (`apps/agrifolio/api/service/`)
...
#### Repositories (`apps/agrifolio/api/repository/`)
...
#### Models (`apps/agrifolio/api/model/`)
